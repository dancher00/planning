...
# Task 1.A: Action space enumeration
# The coordinates of actions are a = (row, column)
# action_space[0] = (-1, 0): move up (decrease row)
# action_space[1] = (0, -1): move left (decrease column)
# action_space[2] = (1, 0): move down (increase row)
# action_space[3] = (0, 1): move right (increase column)
action_space = []
